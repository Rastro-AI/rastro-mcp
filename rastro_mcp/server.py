    ...
    # ── Execution tools ──────────────────────────────────────────────
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "use_cache": {"type": "boolean", "default": True, "description": "Reuse a local snapshot manifest when available"},
                "refresh": {"type": "boolean", "default": False, "description": "Force a live catalog pull and refresh the local cache"},
            },
            "required": ["catalog_id"],
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "base_snapshot_id": {"type": "string", "description": "Optional source snapshot ID for audit trail"},
                "validate_only": {"type": "boolean", "default": False, "description": "Compute diff and validate without creating an activity"},
